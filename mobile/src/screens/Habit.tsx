...
export function Habit() {
  ...
  async function fetchHabits() {
    try {
      ...
      console.log(error)
      Alert.alert('Ops', 'It was not possible to load the habits.')
    } finally {
      setLoading(false)
    }
  }
  ...
  async function handleToggleHabits(habitId: string) {
    try {
      ...
      console.log(error)
      Alert.alert('Ops', 'It was not possible to toggle the habit.')
    }
  }
...

        {
          isDateInPast && (
            <Text className="text-white mt-10 text-center">
             You cannot edit your progress of past dates.
            </Text>
          )
        }
      </ScrollView>
